...
export declare const useFloatingInteractions: ({ context, trigger, role, interactions, }: UseFloatingInteractionsParams) => {
    ...
    getItemProps: (userProps?: (Omit<import("react").HTMLProps<HTMLElement>, "selected" | "active"> & import("@floating-ui/react/src/hooks/useInteractions").ExtendedUserProps) | undefined) => Record<string, unknown>;
};
