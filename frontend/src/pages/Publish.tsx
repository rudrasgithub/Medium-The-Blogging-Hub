        ...
        <div className="w-full mb-4">
            <div className="flex items-center justify-between py-2 border">
                <div className="py-2 bg-white rounded-b-lg w-full">
                    ...
                    <textarea onChange={onChange}id="editor" rows={9} className="focus:outline-none block w-full pl-2 text-sm text-gray-800 bg-white border-0" placeholder="Write an article..." required />
                </div>
            </div>
        </div>
    </div>
